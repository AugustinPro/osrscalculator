...
export declare type Mode = 'normal' | 'ironman' | 'ultimate' | 'hardcore' | 'deadman' | 'seasonal' | 'tournament';
...
export declare type BossName = 'abyssalSire' | 'alchemicalHydra' | 'barrowsChests' | 'bryophyta' | 'callisto' | 'cerberus' | 'chambersOfXeric' | 'chambersOfXericChallengeMode' | 'chaosElemental' | 'chaosFanatic' | 'commanderZilyana' | 'corporealBeast' | 'crazyArchaeologist' | 'dagannothPrime' | 'dagannothRex' | 'dagannothSupreme' | 'derangedArchaeologist' | 'generalGraardor' | 'giantMole' | 'grotesqueGuardians' | 'hespori' | 'kalphiteQueen' | 'kingBlackDragon' | 'kraken' | 'kreeArra' | 'krilTsutsaroth' | 'mimic' | 'nightmare' | 'obor' | 'sarachnis' | 'scorpia' | 'skotizo' | 'theGauntlet' | 'theCorruptedGauntlet' | 'theatreOfBlood' | 'thermonuclearSmokeDevil' | 'tzKalZuk' | 'tzTokJad' | 'venenatis' | 'vetion' | 'vorkath' | 'wintertodt' | 'zalcano' | 'zulrah';
export declare type ClueType = 'all' | 'beginner' | 'easy' | 'medium' | 'hard' | 'elite' | 'master';
export declare type LeaguePoints = 'leaguePoints';
export declare type lastManStanding = 'lastManStanding';
export declare type BountyHunterType = 'hunter' | 'rogue';
export declare type ActivityName = LeaguePoints | BountyHunterType | ClueType | lastManStanding | BossName;
export declare type StatName = ActivityName | SkillName;
...
export declare type RankedStats = {
...
export declare type BountyHunter = {
