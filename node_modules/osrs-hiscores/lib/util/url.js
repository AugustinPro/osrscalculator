 ...
 */
const getUrlModeWithDefault = (mode = 'normal') => urlMode[mode];
/**
 ...
 * @returns {string}
 */
exports.buildStatsUrl = (player, mode) => {
 ...
 * @returns {string}
 */
exports.buildSkillPageUrl = (skill, mode) => {
    const tableIdx = constants_1.SKILLS.indexOf(skill);
 ...
 * @returns {string}
 */
exports.buildActivityPageUrl = (activity, mode) => {
    const tableIdx = constants_1.ACTIVITIES.indexOf(activity);
 ...
 * @returns {string}
 */
exports.buildSkillPageWithDisplayNameUrl = (player, skill, mode) => {
    const defaultOrSkill = skill || 'overall';
    const pageUrl = exports.buildSkillPageUrl(defaultOrSkill, mode);
